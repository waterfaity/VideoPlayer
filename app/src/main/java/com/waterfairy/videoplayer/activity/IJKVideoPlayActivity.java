...
public class IJKVideoPlayActivity extends AppCompatActivity implements OnBackClickListener, OnMediaPlayListener {
    ...
    private IJKVideoPlayerView player;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ijk_video_player_video_play);
